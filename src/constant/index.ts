...
export const user_agents: UserAgents[] = [{ user_agent: 'Airbnb/21057117 AppVersion/20.07.1 Android/10.0 Device/Pixel 2 XL Carrier/US T-MOBILE Type/Phone', screen_size: 'w=360.0;h=640.0' }];
...
export const endpoints: Endpoints = {
    ...
    threads: (id?: string) => (id ? `${maint_host}/threads/${id}` : `${maint_host}/threads`),
    accounts_me: `${maint_host}/accounts/me`,
    user_by_id: (id: string) => `${maint_host}/users/${id}`,
    wishlists: `${maint_host}/wishlists`,
    listings: (id?: string) => (id ? `${maint_host}/listings/${id}` : `${maint_host}/listings`),
